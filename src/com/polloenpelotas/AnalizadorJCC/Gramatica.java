...
public class Gramatica implements GramaticaConstants {
 ...
 AstNode e1, other;
    ...
    case COMA:
      ...
      e1 = Expresion();
     {if (true) return new Access3MatrixAstNode(new FileLocation(token.beginColumn, token.beginLine),e,e1);}
      break;
    case NUMERO:
    case DECIMAL:
    case APAR:
 ...
 AstNode e, other;
  ...
  final public AstNode LeftAccessArray1(AstNode e) throws ParseException {
 AstNode e1, other;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ABRA:
      jj_consume_token(ABRA);
      e1 = Expresion();
      jj_consume_token(CBRA);
     {if (true) return new LeftAccess2AstNode (new FileLocation(token.beginColumn, token.beginLine),e,e1);}
      break;
    case COMA:
      jj_consume_token(COMA);
      e1 = Expresion();
     {if (true) return new LeftAccess3MatrixAstNode(new FileLocation(token.beginColumn, token.beginLine),e,e1);}
      break;
    case NUMERO:
    case DECIMAL:
    case APAR:
 ...
 AstNode e; Token t;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x200,0x200,0x200,0x200,0x0,0x200,0x0,0x200,0x88002580,0x0,0x0,0x0,0x0,0x0,0x4000000,0x2000000,0x1800000,0x1800000,0x1e0000,0x1e0000,0x3000,0x3000,0x1000c000,0x1000c000,0x10000,0x88002580,0x20000000,0xa8002580,0x0,0x80000580,0x0,0x0,0x88002580,0x20000000,0xa8002580,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x17b480,0x17b480,0x17b480,0x0,0x0,0x0,0x0,0x17b480,0x0,0x100000,0x0,0x900341,0x80,0x4200,0x200,0x4000,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x900241,0x0,0x900243,0x2,0x800241,0x100000,0x2,0x900241,0x0,0x900243,0x2,0x2,0x100000,0x100000,};
   }
